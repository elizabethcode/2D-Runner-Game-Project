class Coin2 { //start of coin class
  ...
  PImage img1 = loadImage("coin1Level2.png"); 
  PImage img2 = loadImage("coin2Level2.png");
  PImage img3 = loadImage("coin3Level2.png");
  PImage img4 = loadImage("coin4Level2.png");
  PImage img5 = loadImage("coin5Level2.png");
  PImage img6 = loadImage("coin6Level2.png");
  PImage img7 = loadImage("coin7Level2.png");
  PImage img8 = loadImage("coin8Level2.png");
  int CounterForImage = 0; //image counter
  int lifespan; //related to coin2 erasing all of the coins once restart game

  //constructor
  Coin2(float x, float y) {
  ...
  void render() {//draw it
    ...
    //barrier for the canvas - doesn't render off screen
